...
public class TwitterKeyWordDriver {
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setMapperClass(edu.uprm.cse.bigdata.keywords.TwitterKeyWordMapper.class);
        job.setReducerClass(edu.uprm.cse.bigdata.keywords.TwitterKeyWordReducer.class);
